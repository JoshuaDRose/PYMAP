# Pymap 🦉
[![Pipeline](https://github.com/JoshuaDRose/PYMAP/actions/workflows/main.yml/badge.svg)](https://github.com/JoshuaDRose/PYMAP/actions/workflows/main.yml)
[![pytest](https://github.com/JoshuaDRose/PYMAP/actions/workflows/pytest.yml/badge.svg)](https://github.com/JoshuaDRose/PYMAP/actions/workflows/pytest.yml) [![flake](https://github.com/JoshuaDRose/PYMAP/actions/workflows/flake.yml/badge.svg)](https://github.com/JoshuaDRose/PYMAP/actions/workflows/flake.yml)
## Description
...
| window.main_program_font     	|``` pygame.font```          	| The font object, this does not render stuff nor is a ttf file or anything like that. This just sets a constant value containing paramaters: font type, size, bold, italic.                                                                                                        	| ```pygame.font.SysFont('candara', 24, bold=True)```           	|
...
| Name                            	| Type                                        	| Description                                                                                                                                                                                                   	| Value                       	|
|---------------------------------	|---------------------------------------------	|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	|-----------------------------	|
| TextBox                         	| ```object``` 	| class which as stated previously, inherits both functions and class variables of the pygame.sprite.Sprite class which now allocates text box as a class which is treated as a sprite by the program           	| does not have a return type 	|
